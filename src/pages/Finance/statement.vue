  ...
  <div class="fillcontain">
    ...
    <div class="table_container">
      ...
      >
        ...
        <el-table-column label="服务单价" prop="price" align="center">
          <template slot-scope="scope">
            ￥
        ...
        >
          <template slot-scope="scope">
            <el-tag
              size="mini"
              type="warning"
              v-if="scope.row.isSettlement == 0"
            >
              不可结算
            </el-tag>
            <el-button
              v-if="scope.row.isSettlement == 1"
              type="primary"
              size="mini"
              @click.stop="settle(scope.row)"
            >
              结算
            </el-button>
            <el-tag
